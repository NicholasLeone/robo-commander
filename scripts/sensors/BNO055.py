...
class BNO055(object):
    ...
    def __init__(self, address=BNO055_ADDRESS_A, i2c_bus=1, mux_addr=None,mux_channel=None):
        ...
        elif(i2c_bus is not None): self._i2c_device = Device(address,i2cBus)
        else: print("[ERROR] No I2C bus given!!!!")
