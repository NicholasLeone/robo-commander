...
int main(int argc, char *argv[]){
	...
	cout << "[START] BNO-055..." << endl;
     BNO055_I2C imu1(pi, 1, 0x28, 6, &mux);
	BNO055_I2C imu2(pi, 1, 0x28, 1, &mux);
	BNO055_I2C imu3(pi, 1, 0x28, 3, &mux);
	...
	while(1){
		...
		imu3.get_euler(&angs3[0]);
		printf("IMU Angles: [#1] %.3f, %.3f, %.3f ---- [#2]: %.3f, %.3f, %.3f ---- [#3] %.3f, %.3f, %.3f \r\n", angs1[0], angs1[1] , angs1[2], angs2[0], angs2[1] , angs2[2], angs3[0], angs3[1] , angs3[2]);
		// imu.update(true);
		usleep(dt * 1000000);
	}
     return 0;
