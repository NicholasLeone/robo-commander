...
// NOTE: TEMPORARILY USING SOMEONE ELSES WORK FOR NOW ONLY FOR REFERENCE FOR THE I2C WRITE/READ SEQUENCES
...
void PCA9685::reset() {
		i2c->write_byte(MODE1, 0x00);
		i2c->write_byte(MODE2, 0x04);
}
