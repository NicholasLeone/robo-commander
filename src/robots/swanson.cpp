...
void Swanson::_driveLeft(float speed){
     float front, rear;
...
void Swanson::_driveRight(float speed){
     float front, rear;
...
void Swanson::drive(float v, float w){
...
float Swanson::calculateControlSpeed(PID* _pid, float target, float measurement){
